...
class Autentifikasi extends CI_Controller
{
  ...
  public function logout()
  {
    ...
    $this->session->set-set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Anda telah Logout!!</div>');
    redirect('autentifikasi');
  }
  ...
  public function registrasi()
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $data = [
        'nama' => htmlspecialchars($this->input->post('nama', true)), 'email' => htmlspecialchars($email), 'image' => 'default.jpg',
